    ...
    return (
        <div className="register-page text-center m-5-auto">
            ...
            <div className="flex flex-row justify-center">
                ...
                <div className={` py-2 sm:py-4 sm:px-6 ${cart.length > 2 ? 'box-item' : ''}`}>
                    {cart.map(item => <CartItemPayment key={item.id} item={item}/>)}
                    <div className='flex justify-center pr-0 sm:py-4 sm:pr-6 sm:justify-end'>
                        <div className='w-fit rounded-xl flex flex-col justify-between items-center sm:flex-row sm:py-6 sm:px-4'>
