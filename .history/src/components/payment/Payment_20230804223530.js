...
export function Payment({login}) {
    ...
    const handleChangePayment = (e) => console.log(e)
    return (
            ...
            <div className="flex flex-row justify-center">
                <form className="border-none bg-none m-0" action="/success">
                    ...
                    <p className='flex justify-start pt-2'>
                        <input className='' type="radio" name="checkbox" checked/> <span>Cash On Delivery</span>
                    </p>
                    <p className='flex justify-start pt-2'>
                        <input className='' type="radio" name="checkbox" onChange={handleChangePayment(this)}/> <span>Card</span>
                    </p>
