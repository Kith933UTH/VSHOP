...
export function Payment() {
    ...
    return (
        <div className="payment-page text-center m-5-auto flex justify-center px-[20px]">
            ...
            <div className="flex flex-col-reverse md:flex-row justify-center border-y-2 border-b-2">
                <form id="payment-form" className="border-none bg-none m-0 border-b-2 inline-block p-8" >
                    <p>
                ...
                <div className={`min-w-[400px] max-h-[440px] border-l-2 border-b-2 px-4 pb-4`}>
                    <div className={`px-1 py-2 sm:py-4 sm:px-6 max-h-[400px] overflow-y-scroll`}>
                        {cart.map(item => <CartItemPayment key={item.id} item={item}/>)}    
                    </div>
                    <div className='mr-0 sm:mr-4 font-semibold border'>
