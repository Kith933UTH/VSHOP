...
export function Payment({login}) {
    ...
    const handleChangePayment = () => console.log(111)
    return (
            ...
            <div className="flex flex-row justify-center">
                <form className="border-none bg-none m-0" action="/success">
                    ...
                    <p className='flex justify-start pt-2'>
                        <input className='' type="radio" name="checkbox" checked value={111}/> <span>Cash On Delivery</span>
                    </p>
                    <p className='flex justify-start pt-2'>
                        <input className='' type="radio" name="checkbox" onChange={handleChangePayment()} value={222}/> <span>Card</span>
                    </p>
